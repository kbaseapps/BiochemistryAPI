...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'BiochemistryAPI'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from BiochemistryAPI.BiochemistryAPIImpl import BiochemistryAPI  # noqa @IgnorePep8
impl_BiochemistryAPI = BiochemistryAPI(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_BiochemistryAPI.get_reactions,
                             name='BiochemistryAPI.get_reactions',
                             types=[dict])
        self.method_authentication['BiochemistryAPI.get_reactions'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_BiochemistryAPI.search_compounds,
